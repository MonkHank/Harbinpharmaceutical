...
public class StockInPreSetData implements Serializable {
    private String billNumb;
    private StoreTypeInfo billType;
    private Date createTime;
    private SmartCorpInfo contactCompany;

    public StockInPreSetData() {
    }

    public StockInPreSetData(String billNumb, StoreTypeInfo billType, SmartCorpInfo contactCompany, Date createTime) {
