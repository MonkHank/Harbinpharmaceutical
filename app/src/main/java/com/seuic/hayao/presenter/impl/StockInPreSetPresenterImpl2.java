...
public class StockInPreSetPresenterImpl2 extends BasePresenter<StockInPreSetView2> implements StockInPreSetPresenter2 {
    ...
    public StockInPreSetPresenterImpl2(StockInPreSetView2 view) {
        mDataManager = DataManager.getInstance();
        this.attachView(view);
    }

    @Override
    public void attachView(StockInPreSetView2 view) {
        this.mMvpView = view;
    }
    ...
    public void bindQueryTextView(TextView view) {
        mSubscription3 = RxTextView.textChanges(view).subscribeOn(AndroidSchedulers.mainThread()).debounce(500, TimeUnit.MILLISECONDS, AndroidSchedulers.mainThread()).map(new Func1<CharSequence, ArrayList<SmartCorpInfo>>() {
            @Override
